...
export async function mockAxiosGet(url) {
    switch(url) {
        case "https://front-test-api.herokuapp.com/api/product": // get all products (5 test products)
            return { data: productList };
        case "https://front-test-api.herokuapp.com/api/product/ZmGrkLRPXOTpxsU4jjAcv": // get single product id "ZmGrkLRPXOTpxsU4jjAcv"
...
export async function mockAxiosPost(url, data) {
   if(url == "https://front-test-api.herokuapp.com/api/cart") {
      return { data: { count: 1 } };
   } else {
      return {};
   }
